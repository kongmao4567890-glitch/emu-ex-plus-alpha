...
std::string_view toString(AppKeyCode code)
{
	switch(code)
	{
		case AppKeyCode::openContent: return "打开内容";
		case AppKeyCode::closeContent: return "关闭内容";
		case AppKeyCode::openSystemActions: return "打开系统操作";
		case AppKeyCode::saveState: return "保存状态";
		case AppKeyCode::loadState: return "读取状态";
		case AppKeyCode::decStateSlot: return "减少状态槽位";
		case AppKeyCode::incStateSlot: return "增加状态槽位";
